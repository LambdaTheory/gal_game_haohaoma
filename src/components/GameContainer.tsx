...
const STAR_DATA = [
  ...
  { left: 25.1, top: 91.0, delay: 0.2, duration: 2.83 },
  ...
  { left: 26.2, top: 22.7, delay: 0.4, duration: 2.92 },
  { left: 67.0, top: 59.4, delay: 0.28, duration: 2.8 },
  { left: 34.5, top: 31.1, delay: 1.95, duration: 2.16 },
  { left: 64.0, top: 28.4, delay: 1.1, duration: 2.35 },
  ...
  { left: 64.3, top: 59.4, delay: 1.8, duration: 3.47 },
  ...
  { left: 40.0, top: 81.5, delay: 2.57, duration: 2.2 },
  { left: 35.5, top: 70.5, delay: 0.7, duration: 3.35 },
  ...
  { left: 12.4, top: 18.9, delay: 2.8, duration: 2.31 },
  { left: 42.9, top: 60.3, delay: 2.35, duration: 3.62 },
  { left: 7.0, top: 38.0, delay: 1.0, duration: 2.88 },
  { left: 12.6, top: 76.3, delay: 2.05, duration: 2.2 },
  ...
  { left: 66.4, top: 39.0, delay: 2.98, duration: 2.2 },
  ...
  { left: 80.0, top: 28.1, delay: 2.5, duration: 3.38 },
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-pink-900 via-purple-900 to-indigo-900">
        ...
        <div
          className="absolute top-0 right-0 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
      ...
      <div className="hidden md:flex min-h-screen items-center justify-center p-4">
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 50px rgba(236, 72, 153, 0.3), inset 0 0 50px rgba(168, 85, 247, 0.1)",
          }}
        >
          {children}
        </div>
