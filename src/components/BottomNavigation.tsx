  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-30">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(0, 0, 0, 0.85), rgba(88, 28, 135, 0.4), rgba(147, 51, 234, 0.3))",
          boxShadow:
            "0 -8px 32px rgba(236, 72, 153, 0.3), 0 0 20px rgba(168, 85, 247, 0.2)",
        }}
      >
        {/* 顶部装饰线 */}
              ...
              className={`
                ...
                ${
                  activeTab === tab.id && tab.available
                    ...
                    : "text-white/75 hover:text-pink-200"
                }
              `}
              whileHover={{
                scale: 1.05,
